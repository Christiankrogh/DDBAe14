...
public class script_cameraSmoothFollow2D : MonoBehaviour
{
	...
	void		smooth_camera_tracking			(Transform cameraTransform)
	{
		...
		if ( cameraZoom )
		{
			...
			playerJumpHeight = currentPosition - script_playerControls.startPosition;			// subtract the current heigh from the playerControl start position
